...
const singleFurnitureTemlate = (furnitureData) => html`
	<div class="col-md-4">
...
export const dashBoardTemplate = (furniture) => html` <div class="row space-top">
		<div class="col-md-12">
	...
	<div class="row space-top">
		${furniture.map(singleFurnitureTemlate)}
	</div>`;
