...
let homeTemplate = (isLoggedIn) => html` ${homeTempateVersion(isLoggedIn)} `;

function homeTempateVersion(isLoggedIn) {
	if (isLoggedIn === true) {
...
let homeGuestTemplate = () => html`<div class="container">
	<div class="about-us">
		<div>
...
let homeUserTemplate = () => html`<div class="shoes">
	<div class="shoe">
	...
	<div class="shoe">
		<img src="https://admin.startfitness.co.uk/media/catalog/product/r/e/reebok-crossfit-nano-9-0-fu6827.jpg" />
		<h3>Reebok Nano-9</h3>
...
export function renderHomePage(context) {
	...
	context.renderView(homeTemplate(isLoggedIn));
}
